...
-- CreateEnum
CREATE TYPE "Status" AS ENUM ('PLANNED', 'OPEN', 'INPROGRESS', 'COMPLETED', 'BLOCKED', 'BACKLOG', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "ownerId" ON "Organisation"("ownerId");

-- CreateIndex
CREATE INDEX "slug" ON "Organisation"("slug");

-- CreateIndex
CREATE INDEX "assignedTo_project" ON "Issue"("assignedToId", "projectId");

-- CreateIndex
CREATE INDEX "user_org" ON "Member"("userId", "organisationId");
...
-- AddForeignKey
ALTER TABLE "Issue" ADD CONSTRAINT "Issue_assignedToId_fkey" FOREIGN KEY ("assignedToId") REFERENCES "Member"("id") ON DELETE SET NULL ON UPDATE CASCADE;
